...
import com.udacity.securityService.security.SecurityService;
import com.udacity.securityService.security.StyleService;
...
public class SensorPanel extends JPanel implements StatusListener {
    ...
    // based on ask mentor knowledge question
    @Override
